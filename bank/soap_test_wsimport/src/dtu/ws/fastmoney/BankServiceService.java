 ...
 * 
 */
@WebServiceClient(name = "BankServiceService", targetNamespace = "http://fastmoney.ws.dtu/", wsdlLocation = "http://localhost:80/BankService.wsdl.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:80/BankService.wsdl.xml");
