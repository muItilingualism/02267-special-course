...
public class BankServiceRest {
	...
	public BankServiceRest(String endpoint) {
		this.endpoint = endpoint;
	}

	public String createAccountWithBalance(UserRest user, BigDecimal initialBalance) throws BankServiceException {
	...
	public AccountRest getAccount(String accountId) throws BankServiceException {
		try {
			...
			return new com.fasterxml.jackson.databind.ObjectMapper().readValue(r.getBody(),AccountRest.class);
